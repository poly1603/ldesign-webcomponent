...
| `gradientSegments`    | --                       | 渐变分段（创建分段渐变效果）                                                            | `{ offset: number; color: string; }[]`                                               | `undefined`                               |
...
| `layers`              | --                       | 多层进度（用于显示多个数据）                                                            | `{ percent: number; color: string; label?: string; }[]`                              | `undefined`                               |
| `markers`             | --                       | 动态标记点                                                                     | `{ position: number; color?: string; label?: string; }[]`                            | `undefined`                               |
